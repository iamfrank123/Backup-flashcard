...
const authRoutes = require('./auth.cjs'); // *** Importa il file rinominato ***

const app = express();
const server = http.createServer(app);
const io = new Server(server);

const SECRET = 'supersecretkey'; // Assicurati che sia la stessa chiave usata in auth.cjs
...
// === AUTH MIDDLEWARE (Verifica token per API) ===
...
// === API FLASHCARDS (Tutte protette da 'auth') ===
